...
public final class CelestialUniforms {
	...
	private static Vector4f getUpPosition() {
        ...
        MINECRAFT_SHIM.applyRotationYP(preCelestial, -90.0F);
	...
	private Vector4f getCelestialPositionInWorldSpace(float y) {
        ...
        MINECRAFT_SHIM.applyRotationYP(celestial, -90.0F);
        MINECRAFT_SHIM.applyRotationZP(celestial, sunPathRotation);
        MINECRAFT_SHIM.applyRotationXP(celestial, getSkyAngle() * 360.0F);
