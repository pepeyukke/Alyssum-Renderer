...
public class ModernRenderSectionBuiltInfo {
    /**
     ...
     */
    public static final ContextBundle.Key<RenderSection, List<BlockEntity>> GLOBAL_BLOCK_ENTITIES = new ContextBundle.Key<>(RenderSection.class, List.of());
    /**
     * The collection of block entities contained by this rendered chunk, which are part of its culling volume.
     */
    public static final ContextBundle.Key<RenderSection, List<BlockEntity>> CULLED_BLOCK_ENTITIES = new ContextBundle.Key<>(RenderSection.class, List.of());
